...
const ComunidadScreen = () => {
  ...
  const getActivityIcon = (type) => {
    switch(type) {
      ...
      case 'meal': return 'nutrition-outline';
  ...
  const getActivityColor = (type) => {
    switch(type) {
      case 'run': return '#FFB347';
      case 'workout': return '#FF6B6B';
      case 'meal': return '#4ECDC4';
      case 'yoga': return '#98D8C8';
      case 'nutrition': return '#4ECDC4';
        ...
        <View key={post.id} style={styles.activityCard}>
          <View style={styles.activityHeader}>
            <View style={styles.userInfo}>
              <Ionicons name="person-circle" size={40} color={post.avatarColor} />
              <View>
      ...
      {uneteEvents.map((event) => (
        <View key={event.id} style={styles.eventCard}>
          <View style={styles.eventHeader}>
            <View style={[styles.eventTypeIcon, { backgroundColor: getActivityColor(event.type) + '20' }]}>
              <Ionicons 
          ...
          <View style={styles.eventDetails}>
            ...
            <View style={styles.eventDetail}>
              <Ionicons name="fitness-outline" size={16} color="rgba(255,255,255,0.5)" />
          ...
          <View style={styles.eventFooter}>
            ...
            >
              <Text style={[styles.joinButtonText, event.joined && styles.joinedButtonText]}>
      ...
      {exploraRoutines.map((routine) => (
        <View key={routine.id} style={styles.routineCard}>
          <View style={styles.routineHeader}>
            <View style={[styles.routineTypeIcon, { backgroundColor: getActivityColor(routine.type) + '20' }]}>
              <Ionicons 
          ...
          <View style={styles.routineStats}>
            ...
            <View style={styles.routineStat}>
              <Ionicons name="cellular-outline" size={14} color="rgba(255,255,255,0.5)" />
            ...
            <View style={styles.routineStat}>
              <Ionicons name="bookmark" size={14} color="rgba(255,255,255,0.5)" />
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity 
        style={[styles.tab, activeTab === 'actividad' && styles.activeTab]}
          onPress={() => setActiveTab('actividad')}
          >
              <Text style={[styles.tabText, activeTab === 'actividad' && styles.activeTabText]}>
              Actividad
            </Text>
        </TouchableOpacity>
      <TouchableOpacity 
      ...
      >
      <Text style={[styles.tabText, activeTab === 'unete' && styles.activeTabText]}>
          Únete
          </Text>
        </TouchableOpacity>
      <TouchableOpacity 
      ...
      >
      <Text style={[styles.tabText, activeTab === 'explora' && styles.activeTabText]}>
          Explora
          </Text>
        </TouchableOpacity>
      </View>
      <TouchableOpacity style={styles.notificationButton}>
        <Ionicons name="notifications-outline" size={24} color="rgba(255,255,255,0.96)" />
